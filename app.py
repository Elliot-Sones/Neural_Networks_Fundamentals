...
def load_trained_artifacts(model_path="archive/trained_model.npz"):
    try:
        return load_model(model_path)
    except FileNotFoundError:
        raise RuntimeError(
            f"Model file '{model_path}' not found. Run 'python training.py' to train and create it before launching the app."
        )
